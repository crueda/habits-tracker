...
- [x] 1.1 Rename browser, header, loading, report, export, footer, and documentation surfaces to Agatsu
- [x] 1.2 Update compact letter marks and install icon artwork for the Agatsu identity
